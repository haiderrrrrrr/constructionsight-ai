...
const LayoutApplications = () => {
    ...
    const getClassName = (pathName) => {
        switch (pathName) {
            case "/applications/email": return "apps-email"
            case "/applications/chat": return "apps-chat"
            case "/applications/tasks": return "apps-tasks"
            case "/applications/notes": return "apps-notes"
            case "/applications/calender": return "apps-calendar"
            case "/applications/storage": return "apps-storage"
            default: return null
        }
    }
